<template>
    <v-card flat tile width="100%" class="text-center">
      <v-card-text class="text-center">
        <v-flex xs12 text-xs-center mt-10 mb-5>
          $t('landing.BUY_ME_A_COFFEE_DESCRIPTION')
          <br />
          <br />
          <a class="bmc-button" target="_blank" href="https://www.buymeacoffee.com/muGHf41NT">
            <img
        ...
        <v-flex xs12 text-xs-center mb-5>
          ...
          <br />
          <br />$t('landing.FRONTEND_DOCUMENTATION'):
          <a
        ...
        <v-flex xs12 text-xs-center>
          ...
          <br />
          <br />$t('landing.API_DOCUMENTATION'):
          <a
